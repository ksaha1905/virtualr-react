  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <div className="flex mt-10 justify-center" >
            <video src={video1} type="video/mp4" autoPlay loop muted className="rounded-md w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4">Your browser does not support the video tag</video>
            <video src={video2} type="video/mp4" autoPlay loop muted className="rounded-md w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4">Your browser does not support the video tag</video>
        </div>
    </div>
  )
}
